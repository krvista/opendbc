...
from opendbc.car.carlog import carlog as cloudlog
...
def is_ccnc_angle_platform(flags):
  ...
  only need `HyundaiFlags.CCNC | HyundaiFlags.CANFD_LKA_STEER_MSG_ALT` in
  ...
  reuse this helper.
  """
  return bool(flags & HyundaiFlags.CCNC) and bool(flags & HyundaiFlags.CANFD_LKA_STEER_MSG_ALT)
